...
module.exports.up = (migration) => {
  ...
  site.createField('countryCode')
    .name('Country Code')
    .type('Symbol')
    .required(true)
    .validations([{ unique: true }])

  site.createField('menuUtilities')
    .name('MenuUtilities')
    .type('Link')
    .validations([{ linkContentType: ['navigation'] }])
    .linkType('Entry')

  site.createField('menuNavigation')
    .name('MenuNavigation')
    .type('Link')
    .required(true)
    .validations([{ linkContentType: ['navigation'] }])
  ...
  site.createField('pages')
    .name('Pages')
    .type('Array')
    .items({ type: 'Link', validations: [{ linkContentType: ['contactUsPage', 'homePage', 'page', 'teamPage'] }], linkType: 'Entry' })

  site.createField('footerMainNavigation')
    .name('Footer Main Navigation')
    .type('Link')
    .validations([{ linkContentType: ['navigation'] }])
    .linkType('Entry')

  site.createField('footerSecondaryNavigation')
    .name('Footer Secondary Navigation')
    .type('Link')
    .validations([{ linkContentType: ['navigation'] }])
    .linkType('Entry')

  site.createField('resources')
    .name('Resources')
    .type('Array')
    .items({ type: 'Link', validations: [], linkType: 'Entry' })

  site.createField('signUpTitle')
    .name('Sign Up Title')
    .type('Symbol')
    .required(true)

  site.createField('signUpDescription')
    .name('Sign Up Description')
    .type('Text')
    .required(true)

  site.createField('signUpInputLabel')
    .name('Sign Up Input Label')
    .type('Symbol')
    .required(true)

  site.createField('signUpCallToAction')
  ...
  site.changeFieldControl('footerSecondaryNavigation', 'builtin', 'entryLinkEditor')
