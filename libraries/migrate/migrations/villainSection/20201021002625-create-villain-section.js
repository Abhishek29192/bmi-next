...
module.exports.up = (migration) => {
  const villainSection = migration.createContentType('villainSection')
    .name('Villain Section')
    .displayField('title')
    .description('')

  villainSection.createField('title')
    .name('Title')
    .type('Symbol')
    .required(true)

  villainSection.createField('promo')
    .name('Promo')
    .type('Link')
    .required(true)
  ...
  villainSection.createField('isReversed')
...
module.exports.down = migration => migration.deleteContentType('villainSection')
