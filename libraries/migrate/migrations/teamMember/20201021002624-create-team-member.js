...
module.exports.up = (migration) => {
  ...
  teamMember.createField('name')
    .name('Name')
    .type('Symbol')
    .required(true)

  teamMember.createField('profilePicture')
  ...
  teamMember.createField('jobTitle')
    .name('Job Title')
    .type('Symbol')

  teamMember.createField('links')
    .name('Links')
    .type('Array')
    .required(true)
    .items({ type: 'Link', validations: [{ linkContentType: ['link'] }], linkType: 'Entry' })

  teamMember.createField('category')
    .name('Category')
    .type('Link')
    .required(true)
