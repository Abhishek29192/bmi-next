...
module.exports.up = (migration) => {
  ...
  promo.createField('brandLogo')
    .name('Brand Logo')
    .type('Symbol')
    .validations([{ in: ['Icopal', 'Zanda', 'Monier', 'Monarplan', 'AeroDek'] }])

  promo.createField('image')
    .name('Image')
    .type('Link')
  ...
  promo.createField('cta')
    .name('CTA')
    .type('Link')
    .validations([{ linkContentType: ['link'] }])
    .linkType('Entry')

  promo.changeFieldControl('title', 'builtin', 'singleLine', { helpText: 'This text will be displayed with an underline on the Hero' })
  promo.changeFieldControl('brandLogo', 'builtin', 'dropdown', { helpText: 'Show a brand logo for this promo entry' })
