...
module.exports.up = (migration) => {
  ...
  navigationItem.createField('title')
    .name('Title')
    .type('Symbol')
    .required(true)

  navigationItem.createField('type')
    .name('Type')
    .type('Symbol')
    .required(true)
    .validations([{ in: ['Separator', 'Heading'] }])

  navigationItem.createField('value')
    .name('Value')
    .type('Symbol')
...
module.exports.down = migration => migration.deleteContentType('navigationItem')
