    ...
    if (packageName && submoduleName) {
      ...
      if (exports) {
        ...
        if (typeof exports === "string") targetFilePath = exports;
          ...
          const [exportKey, exportValue] =
            Object.entries(exports).find(([k]) => {
              if (k === submoduleName) return true;
              if (k.endsWith("*"))
                return submoduleName.startsWith(k.slice(0, -1));
          ...
          if (typeof exportValue === "string")
            ...
            // eslint-disable-next-line no-inner-declarations -- External library so don't want to change this too much
