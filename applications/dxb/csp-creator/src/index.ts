...
const main = async (market?: string, environment?: string) => {
  ...
  let scriptSrc = `script-src 'self' 'unsafe-inline' 'unsafe-eval' ${gatsbyHost} https://www.google-analytics.com https://www.googleoptimize.com https://optimize.google.com https://www.googletagmanager.com https://*.googleapis.com https://www.google.com/recaptcha https://www.gstatic.com/recaptcha https://www.recaptcha.net/recaptcha https://www.youtube.com`;
  ...
  let connectSrc = `connect-src 'self' blob: ${gatsbyHost} ${elasticSearchHost}:* ${gcpFunctionsHost} ${pimHosts} https://storage.googleapis.com https://www.google-analytics.com https://www.googletagmanager.com https://*.googleapis.com https://*.gstatic.com`;
  let frameSrc = `frame-src ${gatsbyHost} ${marketOptions.frameSrcExtras} https://www.google.com/recaptcha https://recaptcha.google.com/recaptcha https://www.recaptcha.net/recaptcha https://www.youtube.com https://optimize.google.com`;
  ...
  marketOptions.services.forEach((service) => {
    switch (service) {
      ...
      case "cookieLaw": {
        ...
        connectSrc = `${connectSrc} https://*.cookielaw.org`;
        frameSrc = `${frameSrc} https://*.cookielaw.org`;
        break;
      }
      case "facebook": {
        scriptSrc = `${scriptSrc} https://connect.facebook.net`;
      ...
      case "googleAdServices": {
        ...
        imgSrc = `${imgSrc} https://googleads.g.doubleclick.net https://www.google.com https://www.google.co.uk`;
      ...
      case "linkedin": {
        scriptSrc = `${scriptSrc} https://snap.licdn.com`;
      ...
      case "oneTrust": {
        connectSrc = `${connectSrc} https://*.onetrust.com`;
        break;
      }
      case "outBrain": {
