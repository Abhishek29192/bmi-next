import { GallerySectionImage, GallerySectionVideo } from "../media";

export const createGallerySectionImage = (): GallerySectionImage => ({
...
export const createGallerySectionVideo = (): GallerySectionVideo => ({
