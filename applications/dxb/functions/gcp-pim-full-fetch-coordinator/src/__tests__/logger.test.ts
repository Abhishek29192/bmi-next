...
describe("info", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { info, initialize } = require("../logger");
...
describe("debug", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { debug, initialize } = require("../logger");
    initialize("trace-key");
...
describe("notice", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { initialize, notice } = require("../logger");
    initialize("trace-key");
...
describe("warning", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { initialize, warning } = require("../logger");
    initialize("trace-key");
...
describe("error", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { error, initialize } = require("../logger");
    initialize("trace-key");
...
describe("critical", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { critical, initialize } = require("../logger");
    initialize("trace-key");
...
describe("alert", () => {
  ...
  it("should set the trace key if initialize called before", () => {
    const { alert, initialize } = require("../logger");
    initialize("trace-key");
...
describe("emergency", () => {
  it("should log at the emergency level", () => {
    const { emergency } = require("../logger");
  ...
  it("should set the trace key if initialize called before", () => {
    const { emergency, initialize } = require("../logger");
    initialize("trace-key");
