...
var generateGTMIframe = function generateGTMIframe(_ref2) {
  ...
  return (0, _commonTags.oneLine)(_templateObject2 || (_templateObject2 = (0, _taggedTemplateLiteralLoose2.default)(["<iframe src=\"", "/ns.html?id=", "", "\" height=\"0\" width=\"0\" style=\"display: none; visibility: hidden\" aria-hidden=\"true\"></iframe>"])), selfHostedOrigin, id, environmentParamStr);
};
...
exports.onRenderBody = function (_ref3, _ref4) {
  ...
  var _ref4$ids = _ref4.ids,
    ...
    enableWebVitalsTracking = _ref4$enableWebVitals === void 0 ? false : _ref4$enableWebVitals,
    _ref4$selfHostedOrigi = _ref4.selfHostedOrigin,
    selfHostedOrigin = _ref4$selfHostedOrigi === void 0 ? "https://www.googletagmanager.com" : _ref4$selfHostedOrigi;
