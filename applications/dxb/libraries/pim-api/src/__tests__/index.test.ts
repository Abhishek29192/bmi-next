...
const pimProductsUrl = `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products?currentPage=0&status=approved,discontinued&lang=${process.env.LOCALE}`;
const pimSystemsUrl = `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems?currentPage=0&status=approved&lang=${process.env.LOCALE}`;
...
describe("fetchData", () => {
  ...
  it("should return provided current pages data", async () => {
    ...
    mockResponses(
      ...
      {
        url: `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products?currentPage=18&status=approved,discontinued&lang=${process.env.LOCALE}`,
        method: "GET",
        headers: {
          Authorization: `Bearer access_token`,
          "Content-Type": "application/json"
    ...
    expect(fetchMock).toHaveFetched(
      `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products?currentPage=18&status=approved,discontinued&lang=${process.env.LOCALE}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer access_token`,
...
describe("fetchDataByCode", () => {
  ...
  it("constructs url correctly if itemType === 'systems'", async () => {
    const apiResponse = createSystemsApiResponse();
    const expectedUrl = `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems/system_code?status=approved&version=Staged&lang=${process.env.LOCALE}`;
    mockResponses(
      fetchMock,
      {
        url: pimAuthTokenUrl,
  ...
  it("constructs url correctly if itemType === 'product'", async () => {
    const apiResponse = createProductsApiResponse();
    const expectedUrl = `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products/product_code?status=approved,discontinued&version=Staged&lang=${process.env.LOCALE}`;
    mockResponses(
      fetchMock,
      {
        url: pimAuthTokenUrl,
  ...
  it("constructs url correctly if itemType === 'product' and allowPreviewProducts === true", async () => {
    const apiResponse = createProductsApiResponse();
    const expectedUrl = `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products/preview_product_code?status=approved,discontinued,preview&version=Staged&lang=${process.env.LOCALE}`;
    mockResponses(
      fetchMock,
      {
        url: pimAuthTokenUrl,
  ...
  it("should error if getting data throws 500 error", async () => {
    mockResponses(
      ...
      {
        url: `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems/system_code?status=approved&version=Staged&lang=${process.env.LOCALE}`,
        method: "GET",
        headers: {
          Authorization: `Bearer access_token`,
          "Content-Type": "application/json"
  ...
  it("should return all errors if getting data throws a bad request response", async () => {
    mockResponses(
      ...
      {
        method: "GET",
        url: `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems/system_code?status=approved&version=Online&lang=${process.env.LOCALE}`,
        status: 400,
        body: {
          errors: [
            { type: "error1", message: "Expected error 1" },
...
describe("getProductsByMessageId", () => {
  ...
  it("should error if product request returns a non-ok response", async () => {
    ...
    mockResponses(
      ...
      {
        method: "GET",
        url: `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products?messageId=${messageId}&token=${token}&currentPage=${currentPage}&lang=${process.env.LOCALE}`,
        status: 500,
        body: {
          errors: [
            { type: "error1", message: "Expected error 1" },
    ...
    expect(body).toStrictEqual(expectedBody);
    expect(fetchMock).toHaveFetched(
      `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/products?messageId=${messageId}&token=${token}&currentPage=${currentPage}&lang=${process.env.LOCALE}`,
      {
        method: "GET",
        headers: {
...
describe("getSystemsByMessageId", () => {
  ...
  it("should error if system request returns a non-ok response", async () => {
    ...
    mockResponses(
      ...
      {
        method: "GET",
        url: `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems?messageId=${messageId}&token=${token}&currentPage=${currentPage}&lang=${process.env.LOCALE}`,
        status: 500,
        body: {
          errors: [
            { type: "error1", message: "Expected error 1" },
    ...
    expect(body).toStrictEqual(expectedBody);
    expect(fetchMock).toHaveFetched(
      `${process.env.PIM_HOST}/occ/v2/${process.env.PIM_CATALOG_NAME}/export/systems?messageId=${messageId}&token=${token}&currentPage=${currentPage}&lang=${process.env.LOCALE}`,
      {
        method: "GET",
        headers: {
          Authorization: `Bearer ${accessToken}`,
