...
exports.onPostBuild = /*#__PURE__*/ (function () {
  var _ref3 = (0, _asyncToGenerator2.default)(
    /*#__PURE__*/ _regenerator.default.mark(function _callee(_ref, _ref2) {
      var graphql,
        reporter,
        basePath,
        pathPrefix,
          ...
          while (1) {
            switch ((_context.prev = _context.next)) {
              case 0:
                ...
                (output = _ref2.output),
                  (entryLimit = _ref2.entryLimit),
                  (query = _ref2.query),
                  (excludes = _ref2.excludes),
                  (resolveSiteUrl = _ref2.resolveSiteUrl),
                  (resolvePagePath = _ref2.resolvePagePath),
                  (resolvePages = _ref2.resolvePages),
                  (filterPages = _ref2.filterPages),
                  (serialize = _ref2.serialize),
                  (ignoreSitemapPathPrefix = _ref2.ignoreSitemapPathPrefix);
                _context.next = 4;
              ...
              case 4:
                ...
                _context.next = 9;
                return Promise.resolve(resolveSiteUrl(queryRecords)).catch(
                  function (err) {
                    return reporter.panic(
                      _internals.REPORTER_PREFIX + " Error resolving Site URL",
                      err
                    );
                  }
                );
              ...
              case 9:
                ...
                _context.next = 13;
                return Promise.resolve(resolvePages(queryRecords)).catch(
                  function (err) {
                    return reporter.panic(
                      _internals.REPORTER_PREFIX + " Error resolving Pages",
                      err
                    );
                  }
                );
              ...
              case 13:
                ...
                if (!Array.isArray(allPages)) {
                  reporter.panic(
                    _internals.REPORTER_PREFIX +
                      " The `resolvePages` function did not return an array."
                  );
                }
                ...
                (_pageFilter = (0, _internals.pageFilter)(
                  ...
                  (filteredPages = _pageFilter.filteredPages),
                  (messages = _pageFilter.messages);
              ...
              case 32:
                ...
                reporter.panic(
                  _internals.REPORTER_PREFIX + " Error serializing pages",
                  _context.t0
                );
              ...
              case 37:
                ...
                sitemapPublicPath = _path.default.posix.join(
                  ignoreSitemapPathPrefix ? "" : pathPrefix,
                  output
                );
                return _context.abrupt(
                  "return",
                  (0, _sitemap.simpleSitemapAndIndex)({
                    hostname: siteUrl,
