...
ALTER DEFAULT PRIVILEGES FOR USER company_admin IN SCHEMA public GRANT SELECT ON TABLES TO company_admin;
ALTER DEFAULT PRIVILEGES FOR USER company_admin IN SCHEMA public GRANT USAGE, SELECT ON SEQUENCES TO company_admin;
ALTER DEFAULT PRIVILEGES FOR USER company_admin IN SCHEMA public GRANT EXECUTE ON FUNCTIONS TO company_admin;
