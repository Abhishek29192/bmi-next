...
ALTER TABLE account
    ADD FOREIGN KEY (created_by) REFERENCES account (Id);

CREATE INDEX ON account (created_by);

ALTER TABLE account
    ADD FOREIGN KEY (market_id) REFERENCES market (Id);
...
ALTER TABLE company
    ADD FOREIGN KEY (registered_address_id) REFERENCES address (Id);

CREATE INDEX ON company (registered_address_id);

ALTER TABLE company
    ADD FOREIGN KEY (trading_address_id) REFERENCES address (Id);
...
ALTER TABLE evidence_item
    ADD FOREIGN KEY (guarantee_id) REFERENCES guarantee (Id);

CREATE INDEX ON evidence_item (guarantee_id);

ALTER TABLE guarantee
    ADD FOREIGN KEY (requestor_account_id) REFERENCES account (Id);

CREATE INDEX ON guarantee (requestor_account_id);

ALTER TABLE guarantee
    ADD FOREIGN KEY (responsible_installer_account_id) REFERENCES account (Id);
...
ALTER TABLE guarantee
    ADD FOREIGN KEY (reviewer_account_id) REFERENCES account (Id);
...
ALTER TABLE guaranteed_product
...
ALTER TABLE project
    ADD FOREIGN KEY (building_owner_address_id) REFERENCES address (Id);

CREATE INDEX ON project (building_owner_address_id);

ALTER TABLE project
    ADD FOREIGN KEY (site_address_id) REFERENCES address (Id);
...
SELECT
    SETVAL('guaranteed_product_id_seq', (
            SELECT
                MAX(ID)
            FROM guaranteed_product));
