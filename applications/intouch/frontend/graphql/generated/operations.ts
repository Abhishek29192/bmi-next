...
export type RestartSolutionGuaranteeMutationVariables = SchemaTypes.Exact<{
  projectId: SchemaTypes.Scalars["Int"];
}>;

export type RestartSolutionGuaranteeMutation = {
  __typename?: "Mutation";
  restartSolutionGuarantee?: string | null;
};
