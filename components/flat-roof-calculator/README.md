Flat roof calculator component
...
```jsx
import calculatorData from "./src/samples/calculatorData";
<FlatRoofCalculator
  type="SBS"
  ...
  inputContent={{
    ...
    helpDescription: (
      <>
        Your local BMI Area Sales Manager can support you with step by step
        guidance in using this tool.
        <br />
